...
void CenterAutonomous::setSideToScore(char c, int mode, bool score) {
	...
	if (c == 'L' && mode == 0 && score) {
		...
		AddSequential(new DriveStraight(10.968, 0.5, true, 40));
		AddSequential(new Turn(-50, 0.7, 40));
		AddSequential(new DriveStraight(60.877, 0.5, true, 40));
		AddSequential(new Turn(50, 0.7, 40));
		AddSequential(new DriveStraightBeamBreak(0.3, 20));
		AddSequential(new DriveStraight(1, 0.3, true, 10));
